...
## Three-color slides update

Updated https://www.getcolors.ai/slides/green-kubernetes/ in website commit `1372e5ae78ed29d1331d9639e0da0f29090b7267`. The existing URL now serves 14 slides covering the three native Kubernetes SDKs, DOKS and Redis Operator runtime selection, shared ownership and rendering parity, the historical Green cycle, and the later Red/Blue deployment evidence. Speaker notes distinguish the captured dpkg-lock failure from earlier failures whose cause remains unproven. The slide listing, README, PDF and versioned social card are updated.

Validation: typecheck reported zero diagnostics; the site build produced 172 pages. Chromium layout checks found no overflowing slide content, representative slides were visually reviewed, and the PDF contains 14 pages with the new runtime and deployment evidence. Production workflow https://github.com/getcolors/colors-website/actions/runs/35120773641 passed. All 14 live slide sections match the generated HTML; Cloudflare rewrites script tags through Rocket Loader. The live PDF and social card match their committed SHA256 hashes, and the slide listing shows the updated title and count.
